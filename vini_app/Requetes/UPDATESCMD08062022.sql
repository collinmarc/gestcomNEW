...
WHERE SCMD_COM_TAUX =0 AND SCMD_DATE > '2022-01-01' AND SCMD_ETAT = 16 AND FRNC.FRNC_TYPE_CLIENT = PR.PAR_CODE;


UPDATE SOUSCOMMANDE
SET SCMD_COM_MONTANT = SCMD_COM_BASE * (SCMD_COM_TAUX /100)
WHERE SCMD_COM_MONTANT = 0 AND SCMD_COM_TAUX <>0
AND SCMD_DATE > '2022-01-01' AND SCMD_ETAT = 16 AND SCMD_COM_BASE <>0
