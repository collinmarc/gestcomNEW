...
#Region "Code généré par le Concepteur Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'MnuCol_GenFactCol
        '
        Me.MnuCol_GenFactCol.Checked = True
        ...
        'StatusBar1
        '
        Me.StatusBar1.Location = New System.Drawing.Point(0, 208)
        ...
        Me.ClientSize = New System.Drawing.Size(890, 230)
...
#Region "Prise en charge de la mise à niveau "
    Private Shared m_vb6FormDefInstance As frmMain2
    Private Shared m_InitializingDefInstance As Boolean
    Public Shared Property DefInstance() As frmMain2
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New frmMain2
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As frmMain2)
